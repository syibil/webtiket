	...
	<section id="content">
		<article class="col1">
			<div class="pad_1">
				...
				: Solo<br>
				: +62 81234768880<br>
				<a href="mailto:">: sybltkt@gmail.com</a>
				<h2>For Information</h2>
				<p>Untuk info lebih lanjut ataupun kritik dan saran silahkan hubungi kami melalui alamat atau nomor yang tertera di atas. </p>
			</div>
		</article>
